...
else
{
    ...
    if (!empty($_REQUEST['keywords']))
    {
        ...
        foreach ($arr AS $key => $val)
        {
            ...
            $sc_dsad    = $_REQUEST['sc_ds'] ? " OR ".$GLOBALS['goods_desc_field']." LIKE '%$val%'" : '';
            $keywords  .= "(g.".$GLOBALS['goods_name_field']." LIKE '%$val%' OR goods_sn LIKE '%$val%' OR ".$GLOBALS['keywords_field']." LIKE '%$val%' $sc_dsad)";
    ...
    /* 查询商品 */
    $sql = "SELECT g.goods_id, g.".$GLOBALS['goods_name_field']." as goods_name, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ".
                "IFNULL(mp.user_price, g.shop_price * '$_SESSION[discount]') AS shop_price, ".
                "g.promote_price, g.promote_start_date, g.promote_end_date, g.goods_thumb, b.brand_name,b.brand_logo,g.goods_img, g.".$GLOBALS['goods_brief_field']." as goods_brief, g.goods_type ".
