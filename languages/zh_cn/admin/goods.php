...
$_LANG['lab_seller_note'] = '温馨提示：';
$_LANG['lab_seller_note_en'] = '温馨提示(英文)：';


$_LANG['lab_keywords_en'] = '商品关键词(英文)：';
$_LANG['lab_goods_brief_en'] = '商品简单描述(英文)：';
/*$_LANG['lab_seller_note_en'] = '商家备注(英文)：';*/
