...
function group_buy_list($size, $page)
{
    ...
    $gb_list = array();
    $now = gmtime();
    $sql = "SELECT b.*,g.".$GLOBALS['goods_name_field']." as act_name,g.".$GLOBALS['goods_name_field']." as goods_name, IFNULL(g.goods_thumb, '') AS goods_thumb, b.act_id AS group_buy_id, ".
