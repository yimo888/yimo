...
if (!$smarty->is_cached('category.dwt', $cache_id))
{
    ...
    $sql = "SELECT b.brand_id, b.".$GLOBALS['brand_name_field']." as brand_name, COUNT(*) AS goods_num ".
    ...
    if ($cat['filter_attr'] > 0)
    {
        ...
        foreach ($cat_filter_attr AS $key => $value)
        {
            ...
            if($temp_name = $db->getOne($sql))
            {
                ...
                $sql = "SELECT a.attr_id, MIN(a.goods_attr_id ) AS goods_id, a.".$GLOBALS['attr_value_field']." AS attr_value FROM " . $ecs->table('goods_attr') . " AS a, " . $ecs->table('goods') .
                       " AS g" .
...
function category_get_goods($children, $brand, $min, $max, $ext, $size, $page, $sort, $order)
{
    ...
    /* 获得商品列表 */
    $sql = 'SELECT g.goods_id, g.'.$GLOBALS['goods_name_field'].' as goods_name, g.goods_name_style, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ' .
                "IFNULL(mp.user_price, g.shop_price * '$_SESSION[discount]') AS shop_price, g.promote_price, g.goods_type, " .
                'g.promote_start_date, g.promote_end_date, g.'.$GLOBALS['goods_brief_field'].' as goods_brief, g.goods_thumb, b.brand_name,b.brand_logo , g.goods_img ' .
