...
{
    $sql = "SELECT rank_id, IFNULL(mp.user_price, r.discount * $shop_price / 100) AS price, r.".$GLOBALS['rank_name_field']." as rank_name, r.discount " .
...
{
    $now = gmtime();
    $sql = "SELECT pg.goods_id, ga.act_id, ga.".$GLOBALS['act_name_field']." as act_name, ga.".$GLOBALS['act_desc_field']." as act_desc, ga.goods_name, ga.start_time,
    ...
    foreach ($res as $tempkey => $value)
    {
        ...
        $sql = "SELECT pg.package_id, pg.goods_id, pg.goods_number, pg.admin_id, p.goods_attr, g.goods_sn, g.".$GLOBALS['goods_name_field']." as goods_name, g.market_price, g.goods_thumb, IFNULL(mp.user_price, g.shop_price * '$_SESSION[discount]') AS rank_price
