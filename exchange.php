...
function exchange_get_goods($children, $min, $max, $ext, $size, $page, $sort, $order)
{
    ...
    /* 获得商品列表 */
    $sql = 'SELECT g.goods_id, g.'.$GLOBALS['goods_name_field'].' as goods_name, g.goods_name_style, eg.exchange_integral, ' .
...
{
    $time = gmtime();
    $sql = 'SELECT g.*,g.'.$GLOBALS['goods_name_field'].' as goods_name, b.'.$GLOBALS['brand_name_field'].' as brand_name, c.measure_unit, b.brand_id, b.brand_name AS goods_brand, eg.exchange_integral, eg.is_exchange ' .
