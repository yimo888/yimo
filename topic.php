...
{
    $sql = "SELECT *, ".$GLOBALS['title_field']." as title, ".$GLOBALS['keywords_field']." as keywords, ".$GLOBALS['description_field']." as description, ".$GLOBALS['intro_field']." as intro FROM " . $ecs->table('topic') . " WHERE topic_id = '$topic_id'";
