...
elseif (isset($_POST['Submit']))
{
    ...
    if ($_POST['pay_id'])
    {
        ...
        $sql = "UPDATE " . $ecs->table('payment') .
			   ...
			   " pay_name_en = '$_POST[pay_name_en]'," .
               "    pay_desc = '$_POST[pay_desc]'," .
			   "    pay_desc_en = '$_POST[pay_desc_en]'," .
    ...
    else
    {
        ...
        else
        {
            ...
            $sql = "INSERT INTO " . $ecs->table('payment') . " (pay_code, pay_name, pay_name_en, pay_desc, pay_desc_en, pay_config, is_cod, pay_fee, enabled, is_online)" .
                   "VALUES ('$_POST[pay_code]', '$_POST[pay_name]', '$_POST[pay_name_en]', '$_POST[pay_desc]', '$_POST[pay_desc_en]', '$pay_config', '$_POST[is_cod]', '$pay_fee', 1, '$_POST[is_online]')";
            $db->query($sql);
        }
