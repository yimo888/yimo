...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('article')."(title, cat_id, article_type, is_open, author, ".
                "author_email, keywords, content, add_time, file_url, open_type, link, description,title_en,keywords_en,description_en,content_en) ".
            "VALUES ('$_POST[title]', '$_POST[article_cat]', '$_POST[article_type]', '$_POST[is_open]', ".
                ...
                "'$add_time', '$file_url', '$open_type', '$_POST[link_url]', '$_POST[description]', '$_POST[title_en]', '$_POST[keywords_en]', '$_POST[description_en]', '$_POST[content_en]')";
    $db->query($sql);
...
if ($_REQUEST['act'] =='update')
{
    ...
    if ($exc->edit("title='$_POST[title]',title_en='$_POST[title_en]', cat_id='$_POST[article_cat]', article_type='$_POST[article_type]', is_open='$_POST[is_open]', author='$_POST[author]', author_email='$_POST[author_email]', keywords ='$_POST[keywords]', keywords_en ='$_POST[keywords_en]', file_url ='$file_url', open_type='$open_type', content='$_POST[content]', content_en='$_POST[content_en]', link='$_POST[link_url]', description = '$_POST[description]', description_en = '$_POST[description_en]'", $_POST['id']))
    {
...
elseif ($_REQUEST['act'] == 'edit_title_en')
{
    check_authz_json('article_manage');

    $id    = intval($_POST['id']);
    $title = json_str_iconv(trim($_POST['val']));
	if ($exc->edit("title_en = '$title'", $id))
	{
		clear_cache_files();
		admin_log($title, 'edit', 'article');
		make_json_result(stripslashes($title));
