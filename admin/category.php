...
if ($_REQUEST['act'] == 'insert')
{
	...
	$cat['keywords_en']     = !empty($_POST['keywords_en'])     ? trim($_POST['keywords_en'])     : '';
	
	
	
    $cat['cat_desc']     = !empty($_POST['cat_desc'])     ? $_POST['cat_desc']           : '';
	$cat['cat_desc_en']     = !empty($_POST['cat_desc_en'])     ? $_POST['cat_desc_en']           : '';
    $cat['measure_unit'] = !empty($_POST['measure_unit']) ? trim($_POST['measure_unit']) : '';
	$cat['measure_unit_en']     = !empty($_POST['measure_unit_en'])     ? trim($_POST['measure_unit_en'])     : '';
