...
elseif ($_REQUEST['act'] =='insert')
{
    ...
    /* 插入数据 */
    $record = array('act_name'=>$_POST['package_name'],'act_name_en'=>$_POST['act_name_en'], 'act_desc'=>$_POST['desc'], 'act_desc_en'=>$_POST['desc_en'],
...
elseif ($_REQUEST['act'] =='update')
{
    ...
    /* 更新数据 */
    $record = array('act_name' => $_POST['package_name'],'act_name_en' => $_POST['act_name_en'], 'start_time' => $_POST['start_time'], 'end_time' => $_POST['end_time'],
                    'act_desc' => $_POST['desc'], 'act_desc_en' => $_POST['desc_en'], 'ext_info'=>serialize($info));
