...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('article_cat')."(cat_name,cat_name_en, cat_type, cat_desc, cat_desc_en,keywords,keywords_en, parent_id, sort_order, show_in_nav)
           VALUES ('$_POST[cat_name]','$_POST[cat_name_en]', '$cat_type',  '$_POST[cat_desc]',  '$_POST[cat_desc_en]','$_POST[keywords]','$_POST[keywords_en]', '$_POST[parent_id]', '$_POST[sort_order]', '$_POST[show_in_nav]')";
    $db->query($sql);
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    if ($exc->edit("cat_name = '$_POST[cat_name]', cat_desc ='$_POST[cat_desc]', cat_desc_en ='$_POST[cat_desc_en]', keywords='$_POST[keywords]', keywords_en='$_POST[keywords_en]', cat_name_en='$_POST[cat_name_en]',parent_id = '$_POST[parent_id]', cat_type='$cat_type', sort_order='$_POST[sort_order]', show_in_nav = '$_POST[show_in_nav]'",  $_POST['id']))
    {
