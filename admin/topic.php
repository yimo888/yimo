...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if ($is_insert)
    {
        $sql = "INSERT INTO " . $ecs->table('topic') . " (title,title_en,start_time,end_time,data,intro,template,css,topic_img,title_pic,base_style, htmls,keywords,keywords_en,description_en)" .
                "VALUES ('$_POST[topic_name]','$_POST[topic_name_en]','$start_time','$end_time','$data','$_POST[topic_intro]','$_POST[topic_intro_en]','$_POST[topic_template_file]','$_POST[topic_css]', '$topic_img', '$title_pic', '$base_style', '$htmls','$keywords','$_POST[keywords_en]','$_POST[description]','$_POST[description_en]')";
    }
    else
    {
        $sql = "UPDATE " . $ecs->table('topic') .
                "SET title='$_POST[topic_name]',title_en='$_POST[topic_name_en]',start_time='$start_time',end_time='$end_time',data='$data',intro='$_POST[content]',intro_en='$_POST[content_en]',template='$_POST[topic_template_file]',css='$_POST[topic_css]', topic_img='$topic_img', title_pic='$title_pic', base_style='$base_style', htmls='$htmls', keywords='$keywords', keywords_en='$_POST[keywords_en]', description='$_POST[description]', description_en='$_POST[description_en]'" .
